...
// ===================================================
// 【設定】デプロイ後に以下2つを変更してください
const SHEET_NAME     = '測定記録';
const RESULT_BASE_URL = 'https://あなたのサイトURL/result.html'; // ← 変更必要
// ===================================================
